...
# You can load it back in any script with:
#
# ```julia
# saved_pulse = load("quickstart_pulse.jld2", "pulse")
# qtraj = UnitaryTrajectory(sys, saved_pulse, GATES[:X])
# ```
#
# See the [Saving and Loading Pulses](@ref saving-loading) guide for warm-starting
# and other patterns.
